...
RUN_NAME="DistillCIR_ParallelDualLoRA_BS56_Accum8_ViTL14_SEARLEPhi_And_Drop0p5_GeneCIS"
...
eval_split 4 600 1000 1400 final &
PID_A=$!
eval_split 5 800 1200 1600 &
PID_B=$!
wait "${PID_A}" "${PID_B}"
