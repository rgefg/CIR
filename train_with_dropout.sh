...
DIST_URL="${DIST_URL:-tcp://127.0.0.1:6157}"
TRAIN_CUDA_DEVICES="${TRAIN_CUDA_DEVICES:-${CUDA_VISIBLE_DEVICES:-0,1}}"
RUN_NAME="${RUN_NAME:-DistillCIR_ParallelDualLoRA_BS56_Accum8_EMA1000_QKV_StrictLoss_Exp3_NoResetLogit_Manual}"
POSTHOC_STANDALONE_GPU="${POSTHOC_STANDALONE_GPU:-0}"
POSTHOC_MERGED_GPU="${POSTHOC_MERGED_GPU:-1}"
...
INSTRUCTION_PROMPT_STYLE="${INSTRUCTION_PROMPT_STYLE:-single}"
...
echo "Instruction prompt style: ${INSTRUCTION_PROMPT_STYLE}"
