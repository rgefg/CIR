...
TRAIN_CUDA_DEVICES="${TRAIN_CUDA_DEVICES:-${CUDA_VISIBLE_DEVICES:-0,2}}"
RUN_NAME="${RUN_NAME:-DistillCIR_ParallelDualLoRA_BS56_Accum8_QKV_StrictLoss_dropout0.5_conflictprobe300}"
EVAL_GPU="${EVAL_GPU:-3}"
