...
DIST_URL="${DIST_URL:-tcp://127.0.0.1:6158}"
...
RUN_NAME="${RUN_NAME:-DistillCIR_ParallelDualLoRA_BS56_Accum8_EMA800_QKV_StrictLoss_Exp2_PromptAlign}"
...
INSTRUCTION_PROMPT_STYLE="${INSTRUCTION_PROMPT_STYLE:-duplicate_and}"
